...
export const benefits = [
  {
    ...
    items: ["Вы можете оставить только один вариант или предоставить клиенту выбор.", "Если вы не знаете, как организовать доставку еды на дом, мы подскажем, что нужно делать." ]
  },
  {
    img: menuImage,
